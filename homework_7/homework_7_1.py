...
for i in range(int(100/dt)):
	B = 0.0039 + (1+math.exp((((v_x[i])**2+(v_y[i])**2+(v_z[i])**2)**0.5-v_d)/5))**(-1)*0.0058
	tmp1 = x[i] + v_x[i] * dt
	tmp2 = v_x[i] - B*(((v_x[i])**2+(v_y[i])**2+(v_z[i])**2)**0.5)*v_x[i]*dt
	tmp3 = y[i] + v_y[i] * dt
	tmp4 = v_y[i] - g * dt
	tmp5 = z[i]+v_z[i]*dt
...
ax.set_ylim3d(-50,5)
ax.set_zlim3d(0,50)
ax.plot(x,z,y,label='v_0=50mph',linewidth=2.0)
ax.plot(x_2,z_2,y_2,label='v_0=80mph',linewidth=2.0)
ax.plot(x_3,z_3,y_3,label='v_0=110mph',linewidth=2.0)
ax.legend()
plt.xlabel('x(m)')
plt.ylabel('z(m)')
