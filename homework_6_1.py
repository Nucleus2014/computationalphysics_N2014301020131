...
plot(x_3,y_3,color="green", linestyle="-",linewidth=2.0,label="45")
plot(x_2,y_2,color="red", linestyle="-",linewidth=2.0,label="50")
plot(x_1,y_1,color="yellow", linestyle="-",linewidth=2.0,label="55")
plot(x_5,y_5,color="purple", linestyle="-",linewidth=2.0,label="60")
plot(x_6,y_6,color="orange", linestyle="-",linewidth=2.0,label="65")
